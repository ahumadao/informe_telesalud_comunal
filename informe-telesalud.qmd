...
La población inscrita validada total en el SSMS, correspondiente al año 2024, fue de `r total_piv_2024_formato` personas. Para la comuna de `r comuna_en_uso` fue de `r comma(as.numeric(piv_comuna1$piv_2024))` , lo que corresponde a un `r comma(round(as.numeric(piv_comuna1$piv_2024)/total_piv_2024 *100,2))`% de la población de SSMS. La PIV del 2024 para esta comuna desagregada por establecimiento se menciona en la siguiente tabla.
...
kable(piv_estab %>% filter(comuna == comuna1$comuna[1]) %>% 
        ...
        setNames(c('Centro','PIV 2024')), 
      longtable = TRUE, align = 'cc', caption = 'Población inscrita validada. 2024. Por establecimiento.')
